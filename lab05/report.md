...
![результат программы readfile](image/08.png){ #fig:007 width=70% height=70%}
...
![исследование Sticky-бита](image/09.png){ #fig:008 width=70% height=70%}

![исследование Sticky-бита](image/10.png){ #fig:008 width=70% height=70%}
